-- =====================================================
-- COMMUNICATION VIEWS DESIGN - SEM SCHEMA (FIXED)
...
SELECT 
    ...
    message_type::text as communication_type, -- Cast enum to text
    subject,
    content as body,
...
SELECT 
    ...
    comment_type::text as communication_type, -- Cast enum to text
    CASE 
...
SELECT 
    ...
    message_type as communication_type, -- Already text
    title as subject,
    content as body,
    sender_id as author_id,
    recipient_id,
    ...
    false as is_urgent,
    false as requires_response,
    COALESCE(private, false) as is_private, -- Handle potential nulls
    1 as priority,
    NULL::timestamp with time zone as read_at,
    NULL::timestamp with time zone as responded_at,
    created_at,
...
SELECT 
    ...
    communication_type::text as communication_type, -- Cast enum to text
    subject,
    body,
    author_id,
    NULL::uuid as recipient_id,
...
SELECT 
    ...
    recipient_type,
    is_read,
    COALESCE(private, false) as is_private,
    created_at,
    updated_at,
    legacy_record_id,
    metadata,
