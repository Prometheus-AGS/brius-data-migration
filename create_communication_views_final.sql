-- =====================================================
-- COMMUNICATION VIEWS DESIGN - SEM SCHEMA (FINAL)
-- Based on analysis of existing migrated data
-- All views in sem schema with v_ prefix
-- Final corrected version with proper column handling
-- =====================================================
...
SELECT 
    ...
    NULL::timestamp with time zone as responded_at,
    created_at,
    created_at as updated_at, -- Use created_at for both since updated_at might be duplicated
    legacy_record_id,
    metadata,
    NULL::jsonb as related_tooth_numbers,
    NULL::text as treatment_phase,
