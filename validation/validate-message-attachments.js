...
exports.MessageAttachmentsValidator = void 0;
exports.validateMessageAttachments = main;
...
class MessageAttachmentsValidator {
    constructor() {
    ...
    async validateAttachmentSpecificRules() {
        const issues = [];
        const targetClient = this.connectionManager.getTargetClient();
        try {
            // Get total record count
    ...
    async generateValidationReport(result) {
        ...
        const report = await this.reportGenerator.generateTableReport('message-attachments-validation', migrationStats, result);
    ...
    async getValidationSummary() {
        ...
        const targetClient = this.connectionManager.getTargetClient();
        const attachmentTypeDistribution = {};
...
exports.MessageAttachmentsValidator = MessageAttachmentsValidator;
// Main execution
async function main() {
    try {
...
//# sourceMappingURL=validate-message-attachments.js.map