...
exports.TechnicianRolesValidator = void 0;
exports.validateTechnicianRoles = main;
...
class TechnicianRolesValidator {
    constructor() {
    ...
    async validateCompleteness() {
        return await this.validator.validateCompleteness('dispatch_technician_role', 'technician_roles');
    }
    ...
    async validateRoleSpecificRules() {
        const issues = [];
        const targetClient = this.connectionManager.getTargetClient();
        try {
            // Get total record count
    ...
    async generateValidationReport(result) {
        ...
        const report = await this.reportGenerator.generateTableReport('technician-roles-validation', migrationStats, result);
...
exports.TechnicianRolesValidator = TechnicianRolesValidator;
// Main execution
async function main() {
    try {
...
//# sourceMappingURL=validate-technician-roles.js.map